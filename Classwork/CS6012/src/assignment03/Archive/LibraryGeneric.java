...
public class LibraryGeneric<Type> {
    ...
    public Type lookup(long isbn) {
        ...
        for (LibraryBookGeneric<Type> l : library) {
            if (l.getIsbn() == isbn) {
    ...
    public boolean checkin(Type holder) {
        ...
        ArrayList<LibraryBookGeneric<Type>> toReturn = lookup(holder);


        if (toReturn.size() > 0) {
            for (LibraryBookGeneric<Type> l : toReturn) {
                l.setHolder(null);
                l.setDueDate(null);
            }
            return true;
    ...
    public ArrayList<LibraryBookGeneric<Type>> getOverdueList(int month, int day,
        ...
        for(LibraryBookGeneric<Type> l : library){
//            GregorianCalendar dueDate = l.getDueDate();
            if(l.getDueDate() != null) {
                if (l.getDueDate().compareTo(now) == -1) {
                    overDue.add(l);
                }
            }
        }
    ...
    protected class OrderByAuthor implements Comparator<LibraryBookGeneric<Type>> {
        ...
        public int compare(LibraryBookGeneric<Type> o1, LibraryBookGeneric<Type> o2) {
            ...
            int compareAuthor = o1.getAuthor().compareTo(o2.getAuthor());
            if (compareAuthor != 0) {
    ...
    public Comparator<LibraryBookGeneric<Type>> getComparator(){
