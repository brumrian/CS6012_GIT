...
/**
 * Class representation of a generic library (a collection of library books). Can be used with generic holders.
 *
 */
...
public class LibraryGeneric <Type> {
     ...
     *
     * Works with generic holders, so they can be of any type.
     *
     * @param holder
     *          -- holder whose checked out books are returned. holder is generic.
     */
     ...
     * @param holder
     *          -- new holder of the library book. holder is generic.
     * @param month
     ...
     *
     * @param holder
     *          -- holder of the library books to be checked in. holder is generic.
     */
    ...
    public ArrayList<LibraryBookGeneric<Type>> getOverdueList(int month, int day, int year) {
        ...
        for (LibraryBookGeneric<Type> book : library){
            GregorianCalendar dueDateInput = new GregorianCalendar(year, month, day);

            if (book.getDueDate() != null){

                int compare = book.getDueDate().compareTo(dueDateInput);
                if (compare < 0){
    ...
    public Comparator<LibraryBookGeneric<Type>> getOrderByAuthorComparator(){
    ...
    protected class OrderByDueDate implements Comparator<LibraryBookGeneric<Type>> {
        ...
        public int compare(LibraryBookGeneric<Type> o1, LibraryBookGeneric<Type> o2) {
            ...
            int comparison = o1.getDueDate().compareTo(o2.getDueDate());
