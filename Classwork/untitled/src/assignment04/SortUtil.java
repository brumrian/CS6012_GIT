...
public class SortUtil <T> {
    ...
    private static int insertionThreshold = 20;
    ...
    private static <T> void mergeSortRecursive(ArrayList<T> inputArray, T[] temp, Comparator<? super T> comparator, int left, int right){
        ...
        // Call insertion sort when the subarray size reaches the specified insertion sort threshold and sort that portion of the array
